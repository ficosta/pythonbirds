...
class Passaro(Ator):
    ...
    def _calcular_posicao_vertical(self, delta_t):
        ...
        rad = math.radians(self._angulo_de_lancamento)
        y_atual += self.velocidade_escalar * delta_t * math.sin(rad)
        y_atual -= (GRAVIDADE/2 * (delta_t**2)) /2
        self.y = y_atual #De boa alterar assim?
